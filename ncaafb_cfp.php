...
$json_file = file_get_contents('http://api.sportradar.us/ncaafb-t1/polls/CFP25/2015/10/rankings.json?api_key=vdmmregqeetyd9cry962fvq9');
...
<body>
    <div class="container">
        ...
        <div class="content" style="margin-top:20px;">
           ...
           <h1 class="main_title">College Football Playoff Rankings</h1>
