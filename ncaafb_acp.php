...
* Subject : NCAAFB Amway Coaches Poll
* http://www.ourlads.com/ncaa-football-depth-charts/
*/


// copy file content into a string var
 $json_file = file_get_contents('http://api.sportradar.us/ncaafb-t1/polls/EU25/2016/10/rankings.json?api_key=vdmmregqeetyd9cry962fvq9');
...
<body>
    <div class="container">
     ...
     <div class="content" style="margin-top:20px;">
           ...
           <h1 class="main_title">Amway Coaches Poll</h1>

            <table class="table table-bordered table-striped">

            <?php

            foreach ($acp25 as $post) {
